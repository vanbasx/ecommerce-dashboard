      ...
      <div class="">
         ...
         <div class="p-12 mb-8 w-[480px] mx-auto bg-white rounded-xl border-[#DFEAF2] border-[1px] text-sm">
            <form action="" class="pb-12">
               ...
               <button class="bg-black text-white font-bold w-full p-3 rounded-md tracking-wide">Sign In</button>
            </form>
            ...
            <a href="" class="text-[#111827] font-medium border-[1px] border-[#CBD5E1] w-full flex p-3 rounded-md">
               <div class="mx-auto">
         ...
         <p class="text-center flex items-center gap-1 justify-center text-sm text-[#767676]">Not a member?<a href="" class="text-[#111827]">Create account!</a></p>
      </div>
   </main>
</body>
</html>