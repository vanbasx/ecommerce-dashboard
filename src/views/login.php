   ...
   <main class="mx-auto px-4 flex justify-center items-center h-[100vh]">
      <div class="">
         ...
         <div class="p-12 mb-8 w-[480px] mx-auto bg-white rounded-xl border-[#DFEAF2] border-[1px] text-sm">
            <form action="" class="pb-12">
               ...
               <div class="flex flex-col gap-2 text-[#111827] pb-8">
                  ...
                  <div class="flex items-center">
                     <input type="password" placeholder="Enter your password" class="w-full border-[1px] border-[#CBD5E1] px-3 py-1.5 rounded-md placeholder:text-[#9E9E9E] outline-[#157EFD] shadow-sm">
                     <button type="button" class="ml-[-27px]"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_24_49)"><mask id="mask0_24_49" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="15" height="15"><path d="M15 0H0V15H15V0Z" fill="white"/></mask><g mask="url(#mask0_24_49)"><path d="M6.70637 3.17074C6.96556 3.14053 7.23031 3.125 7.5 3.125C10.415 3.125 12.7499 4.93915 13.75 7.5C13.5034 8.1315 13.1756 8.71762 12.7779 9.24231M4.07476 4.07465C2.79972 4.85254 1.81319 6.05787 1.25 7.5C2.25009 10.0609 4.58502 11.875 7.5 11.875C8.7735 11.875 9.93625 11.5288 10.9254 10.9253M6.17423 6.17412C5.83489 6.51344 5.625 6.98219 5.625 7.5C5.625 8.53556 6.46444 9.375 7.5 9.375C8.01781 9.375 8.48656 9.16512 8.82587 8.82575" stroke="#9E9E9E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M2.5 2.5L12.5 12.5" stroke="#9E9E9E" stroke-width="1.5" stroke-linecap="round"/></g></g><defs><clipPath id="clip0_24_49"><rect width="15" height="15" fill="white"/></clipPath></defs></svg></button>
                  </div>
               </div>
               <div class="flex justify-between items-center pb-8">
                  ...
                  <a href="" class="text-[#111827] font-medium">Forgot password?</a>
               </div>
               <button class="bg-black text-white font-bold w-full p-3 rounded-md tracking-wide hover:shadow transition-shadow duration-300">Sign In</button>
            </form>
            ...
            <a href="" class="text-[#111827] font-medium border-[1px] border-[#CBD5E1] w-full flex p-3 rounded-md hover:shadow-sm transition-shadow duration-300">
               <div class="mx-auto">
         ...
         <p class="text-center flex items-center gap-1 justify-center text-sm text-[#767676]">Not a member?<a href="registration.php" class="text-[#111827]">Create account!</a></p>
      </div>
   </main>
</body>
</html>